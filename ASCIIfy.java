 ...
 * ASCIIfy.java
 *
 * A utility to sanitise specctra DSN files with non ASCII content for autorouting
 * and simplify subsequent restoration of the non ASCII text in the autorouted .ses file.
 *
 * Usage:
